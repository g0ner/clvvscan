...
def get_args():
    ...
    parser.add_argument('-ms', '--max-speed',
                        help='Max speed allowed in spawnpoint mode. Defaults to 30 m/s', type=float, default=30)
    parser.add_argument('-md', '--max-delay',
                        help='Max delay allowed in spawnpoint mode. Defaults to 30s', type=float, default=60)
